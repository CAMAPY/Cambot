...
class Fun(commands.Cog, description = "Fun times with the bot come from here"):
    ...
    async def truth(self, ctx):
        ...
        ,"If you were stuck on a deserted island which friend would you want with you?", "What was your childhood nickname (and why)?", "Have you ever cheated on a test?", "Are you scared of dying? Why?", "What do you think is your biggest physical flaw?", "If you could invent anything, what would it be?", "What does your sibling know about you that no one else does?", "If you could be a superhero, what would your power be?", "Given the choice, would you want to hang out with your parents?", "Would you rather eat a pigeon or a subway rat?", "Would you do anything for money?", "What personality traits would cause you to end a friendship?", "Have you ever told a lie during a game of Truth? What was it and why?", "Which person here knows something about you that you wouldn't want revealed?", "Have you ever pretended to be older or younger than you are to be able to do something?", "Who do you hate the most in this server?", "Who do you think is the most attractive in this server?", "Who is the most funny in here?",
        "What was the last thing you searched for on your phone?", "Do you ever pick your nose?", "Who would you wanna trade lives with in this server?", "How would you rate your looks on a scale of 1 to 10?", "Who is your favorite: Mom or Dad?", "Would you trade your sibling in for a million dollars?", "Would you rather lose your sex organs forever or gain 200 pounds?", "If you could only hear one song for the rest of your life, what would it be?", "Who in this server would be the worst person to date? Why?", "If someone offered you $1 million to break up with your ~~hypothetical~~ girlfriend/boyfriend, would you do it?", "Who is one person you pretend to like in this server, but actually don’t?"]
